...
if (!empty($apellido)) {
    $resultados = $cliente->buscarPorApellido($apellido);
} else {
...
<body>
    <br><br><br>
    <h2>Lideres y Coordinadores</h2><br>
    ...
    <form class="col-10 offset-1" method="GET" enctype="multipart/form-data">
        ...
        <?php if (!empty($apellido)): ?>
            <div class="col-12 col-lg-6">
                ...
                <select class="form-control" name="fk_persona" onchange="this.form.submit()" required>
        ...
        <div class="col-12 col-lg-6">
            ...
            <select class="form-control" name="fk_estado" onchange="this.form.submit()" required>
