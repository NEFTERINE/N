...
<body>
    ...
    <form class="col-10 offset-1" action="insertar_datos.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <p class="p">¿La persona ya esta registrada? <a href="formulario_lider_coordinador.php">Asignar</a></p>
        </div>
    </form>
</body>
